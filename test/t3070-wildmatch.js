/**
 * Tests extracted from the original git repository
...
suite('original wildmatch', function() {

	suite('Basic wildmat features', function() {
	...
	suite('Extended slash-matching features', function() {
	...
	suite('Various additional tests', function() {
	...
	suite('Character class tests', function() {
	...
	suite('Additional tests, including some malformed wildmats', function() {
		makeTest.match(']', '[\\\\-^]');
		makeTest.nomatch('[', '[\\\\-^]');
		makeTest.match('-', '[\\-_]');
		makeTest.match(']', '[\\]]');
	...
	suite('Test recursion and the abort code', function() {
	...
	suite('Test pathName option', function() {
	...
	suite('Case-sensitivy features', function() {
	...
	suite('Additional tests not found in the original wildmatch', function() {
